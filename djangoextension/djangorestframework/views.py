...
from compat import View as DjangoView, apply_markdown
from response import Response, ErrorResponse
from mixins import *
import resources, renderers, parsers, authentication, permissions, status
...
class ListOrCreateModelUserView(ListModelMixin, CreateModelUserMixin, ModelView):
    """
    A view which provides default operations for list and create, against a model in the database.
    """
    _suffix = 'List' 
